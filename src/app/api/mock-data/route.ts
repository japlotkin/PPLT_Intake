...
const fixture: DashboardData = {
  ...
  cost: {
    ...
    totalCpsc: 590.7,
    byPracticeArea: [
      { area: "Auto", spend: 9842, leadsMeta: 248, signed: 18, referred: 22, cpl: 39.69, cpsc: 546.78, avgDaysToSigned: 8.4, avgDaysToReferred: 3.1, adCount: 14, cohortMaturing: true },
      { area: "Workers' Comp", spend: 4710, leadsMeta: 91, signed: 9, referred: 7, cpl: 51.76, cpsc: 523.33, avgDaysToSigned: 11.2, avgDaysToReferred: 4.0, adCount: 8, cohortMaturing: true },
      { area: "Dog Bite", spend: 3104, leadsMeta: 82, signed: 5, referred: 9, cpl: 37.85, cpsc: 620.8, avgDaysToSigned: 6.7, avgDaysToReferred: 2.5, adCount: 6, cohortMaturing: true },
      { area: "Mass Tort: Hair Relaxer", spend: 2417, leadsMeta: 54, signed: 4, referred: 8, cpl: 44.76, cpsc: 604.25, avgDaysToSigned: 12.0, avgDaysToReferred: 5.5, adCount: 4, cohortMaturing: true },
      { area: "Mass Tort: Ultra Processed Foods", spend: 1812, leadsMeta: 41, signed: 3, referred: 3, cpl: 44.20, cpsc: 604.0, avgDaysToSigned: 14.5, avgDaysToReferred: 6.0, adCount: 3, cohortMaturing: true },
      { area: "Disability", spend: 1041, leadsMeta: 38, signed: 1, referred: 0, cpl: 27.39, cpsc: 1041.0, avgDaysToSigned: 18.3, avgDaysToReferred: null, adCount: 2, cohortMaturing: true },
      { area: "Unclassified", spend: 1292, leadsMeta: 58, signed: 1, referred: 0, cpl: 22.28, cpsc: 1292.0, avgDaysToSigned: 22.1, avgDaysToReferred: null, adCount: 7, cohortMaturing: true },
    ],
    byAd: [
      { adId: "1001", adName: "Auto - Hospital lobby v3", campaignName: "PPLT Auto", adsetName: "MD 18-65", account: "pplt", practiceArea: "auto", spend: 1487, leadsMeta: 41, signed: 4, referred: 5, cpl: 36.27, cpsc: 371.75, avgDaysToSigned: 7.2, avgDaysToReferred: 2.5, cohortMaturing: true },
      { adId: "1002", adName: "Workers comp - construction worker", campaignName: "WCC May", adsetName: "MD 25-55", account: "workersComp", practiceArea: "workers_comp", spend: 1204, leadsMeta: 28, signed: 3, referred: 3, cpl: 43.0, cpsc: 401.33, avgDaysToSigned: 9.8, avgDaysToReferred: 3.4, cohortMaturing: true },
      { adId: "1003", adName: "Dog Bite - kids playground", campaignName: "PPLT Dog Bite", adsetName: "MD parents", account: "pplt", practiceArea: "dog_bite", spend: 942, leadsMeta: 31, signed: 2, referred: 4, cpl: 30.39, cpsc: 471.0, avgDaysToSigned: 5.1, avgDaysToReferred: 1.8, cohortMaturing: true },
      { adId: "1004", adName: "Abogado MVA - Spanish testimonial", campaignName: "AA MVA", adsetName: "MD Latino", account: "abogado", practiceArea: "auto", spend: 824, leadsMeta: 22, signed: 2, referred: 4, cpl: 37.45, cpsc: 412.0, avgDaysToSigned: 8.6, avgDaysToReferred: 3.2, cohortMaturing: true },
      { adId: "1005", adName: "HRMT lead form", campaignName: "PPLT HRMT", adsetName: "Women 35-65", account: "pplt", practiceArea: "mass_tort_hair_relaxer", spend: 612, leadsMeta: 14, signed: 1, referred: 2, cpl: 43.71, cpsc: 612.0, avgDaysToSigned: 11.4, avgDaysToReferred: 4.7, cohortMaturing: true },
    ],
    byAreaState: [
      { area: "Auto", state: "MD", spend: 7842, leads: 192, signed: 14, referred: 18, cpl: 40.84, cpsc: 560.14, avgDaysToSigned: 8.1, avgDaysToReferred: 2.9, cohortMaturing: true },
      { area: "Workers' Comp", state: "MD", spend: 3920, leads: 78, signed: 7, referred: 6, cpl: 50.26, cpsc: 560.0, avgDaysToSigned: 10.6, avgDaysToReferred: 3.8, cohortMaturing: true },
      { area: "Dog Bite", state: "MD", spend: 2410, leads: 64, signed: 4, referred: 7, cpl: 37.66, cpsc: 602.5, avgDaysToSigned: 6.2, avgDaysToReferred: 2.1, cohortMaturing: true },
      { area: "Auto", state: "DC", spend: 1198, leads: 28, signed: 2, referred: 2, cpl: 42.79, cpsc: 599.0, avgDaysToSigned: 9.3, avgDaysToReferred: 3.5, cohortMaturing: true },
      { area: "Mass Tort: Hair Relaxer", state: "MD", spend: 1841, leads: 41, signed: 3, referred: 6, cpl: 44.9, cpsc: 613.67, avgDaysToSigned: 12.5, avgDaysToReferred: 5.4, cohortMaturing: true },
      { area: "Auto", state: "VA", spend: 802, leads: 18, signed: 1, referred: 2, cpl: 44.56, cpsc: 802.0, avgDaysToSigned: 11.7, avgDaysToReferred: 4.2, cohortMaturing: true },
      { area: "Workers' Comp", state: "DC", spend: 614, leads: 11, signed: 1, referred: 1, cpl: 55.82, cpsc: 614.0, avgDaysToSigned: 13.1, avgDaysToReferred: 5.0, cohortMaturing: true },
      { area: "Auto", state: "Unknown", spend: 942, leads: 24, signed: 1, referred: 0, cpl: 39.25, cpsc: 942.0, avgDaysToSigned: 16.4, avgDaysToReferred: null, cohortMaturing: true },
    ],
  },
  warnings: [
